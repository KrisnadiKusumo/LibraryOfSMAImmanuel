					...
					<div class="card">
						<div class="card-header">
							...
							<div class="mb-3 d-flex justify-content-center demo-inline-spacing">
								...
								<a href="<?= site_url('transaksi/active') ?>" class="btn rounded-pill btn-outline-dark">
									Aktif
								</a>
								<a href="<?= site_url('transaksi/selesai') ?>" class="btn rounded-pill btn-outline-dark active">
									Selesai
								</a>
							</div>
						</div>
