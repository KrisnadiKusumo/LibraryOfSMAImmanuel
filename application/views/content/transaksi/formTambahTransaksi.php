				...
				<div class="container-xxl flex-grow-1 container-p-y">
					...
					<div class="row">
						<div class="col-xl">
							<div class="card mb-4">
								<div class="card-body">
									<form id="form-tambah-buku" method="post" action="<?= site_url('transaksi/insert') ?>" enctype="multipart/form-data">
										<div class="mb-3">
									...
									<a href="<?= site_url('transaksi') ?>" class="btn btn-outline-primary">
