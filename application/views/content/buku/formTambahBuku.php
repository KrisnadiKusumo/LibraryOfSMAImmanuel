				...
				<div class="container-xxl flex-grow-1 container-p-y">
					...
					<div class="row">
						<div class="col-xl">
							<div class="card mb-4">
								<div class="card-body">
									<form id="form-tambah-buku" method="post" action="<?= site_url('buku/insertBuku') ?>" enctype="multipart/form-data">
										<div class="mb-3">
										...
										<div class="mb-3">
											...
											<input onchange="cekKodeBuku()" require type="text" class="form-control" id="kode_buku" name="kode_buku" placeholder="Masukkan Kode Buku" />
										</div>
										<div class="mb-3">
