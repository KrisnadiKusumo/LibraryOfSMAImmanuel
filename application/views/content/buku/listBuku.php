	...
	<div class="layout-container">
		...
		<div class="layout-page">
			...
			<div class="content-wrapper">
							...
							<div class="card-header">
								...
								<div class="d-flex justify-content-between">
									<div class="button-wrapper">
										<a href="<?= site_url('buku/tambahBuku') ?>" class="btn btn-primary">
									...
									<form class="d-flex" onsubmit="return false">
										<input class="form-control me-2" onkeyup="cariBuku()" type="text" id="searchinput" placeholder="Cari..." aria-label="Search" />
									</form>
								</div>
							</div>
					...
					<form id="form-delete" method="post" action="<?= site_url('buku/deleteBuku') ?>">
					</form>
				</div>
			</div>
