...
<head>
	...
	<title>Unauthorized | SIP SMA IMMANUEL KALASAN</title>

	<meta name="description" content="" />

	<!-- Favicon -->
	<link rel="icon" type="image/x-icon" href="<?php base_url();?>/assets/img/LogoSMAIMMANUEL.png" />
	...
	<!-- Page CSS -->
	<!-- Page -->
	<link rel="stylesheet" href="<?php base_url();?>/assets/vendor/css/pages/page-misc.css" />
	<!-- Helpers -->
...
<div class="container-xxl container-p-y">
	<div class="misc-wrapper">
		...
		<p class="mb-4 mx-2">Oops! 😖 You are not authorized to access this URL.</p>
		<div class="mt-3">
			<img
				src="<?php base_url();?>/assets/img/401.png"
				alt="page-misc-error-light"
				width="500"
				class="img-fluid"
				data-app-dark-img="illustrations/401.png"
				data-app-light-img="illustrations/401.png"
			/>
		</div>
	</div>
</div>
